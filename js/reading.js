...
const DOKKAI_ARTICLE_ICONS = {
  ...
  "reading-18": `<svg viewBox="0 0 200 120"><rect width="200" height="120" fill="#0a0c1a"/><path d="M20 90 L180 90" stroke="#6b93ff" stroke-width="3"/><path d="M20 70 L180 70" stroke="#6b93ff" stroke-width="1" stroke-dasharray="4 4" opacity="0.5"/><circle cx="60" cy="90" r="4" fill="#ffd15c"/><circle cx="100" cy="90" r="4" fill="#ffd15c"/><circle cx="140" cy="90" r="4" fill="#ffd15c"/><path d="M30 40 L60 20 L170 20" stroke="#48c98c" stroke-width="2" fill="none"/></svg>`,
  "reading-19": `<svg viewBox="0 0 200 120"><rect width="200" height="120" fill="#0a0c1a"/><g stroke="#6b93ff" stroke-width="1" opacity="0.6"><path d="M40 30 L160 30 M40 50 L160 50 M40 70 L160 70 M40 90 L160 90"/><path d="M40 30 L40 90 M70 30 L70 90 M100 30 L100 90 M130 30 L130 90 M160 30 L160 90"/></g><circle cx="70" cy="50" r="7" fill="#ffd15c"/><circle cx="130" cy="70" r="7" fill="#ff6b6b"/></svg>`,
};
...
function renderDokkaiVocabSidebar(vocabIndex) {
  ...
  const SERIES_COLORS = { mimi: "#48c98c", tango: "#ff6b6b", n2vocab: "#a98bff", n1vocab: "#a98bff", n3vocab: "#a98bff", khac: "var(--text-2)" }; // xanh=Mimi, đỏ=Tango, tím=JLPT N2 (cả N2/N1 import), xám=Khác
